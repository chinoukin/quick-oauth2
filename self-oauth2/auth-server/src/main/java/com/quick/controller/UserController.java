...
//    @GetMapping("/userinfo")
//    public Map<String, Object> userinfo(@AuthenticationPrincipal OAuth2Authentication authentication) {
...
//                userInfo.put("client_id", authentication.getOAuth2Request().getClientId());
...
//    }
    ...
    public Map<String, Object> userinfo(Authentication authentication) {
        ...
        map.put("user_name", oauth2Auth.getName());
